...
import { Briefcase, BookOpen, Trophy, Flame, Gem, Sparkles, Award, UserPlus, Check, Clock } from 'lucide-react';
import Modal from '../ui/Modal';
import Button from '../ui/Button';
import Avatar from '../ui/Avatar';
import Badge from '../ui/Badge';
import Card from '../ui/Card';
import { useApiUserProfile, useApiFriends } from '../../hooks/useApi';
...
export default function ProfileModal({ isOpen, onClose, userId, userName, userAvatar }: ProfileModalProps) {
  ...
  const { getUserProfile, getUserStats } = useApiUserProfile();
  const { sendFriendRequest, friends, loadFriends } = useApiFriends();
