...
import { FileText, Award, Loader, Check } from 'lucide-react';
...
export default function EditAssignmentModal({ isOpen, onClose, onSubmit, assignment, syllabus }: EditAssignmentModalProps) {
