...
export default function RoomProfile({ room, isMember, onJoin, joining, onRoomUpdate }: RoomProfileProps) {
  ...
  const loadAssignments = async () => {
    ...
    try {
      ...
      const assignmentsList = await assignmentService.getRoomAssignments(room.id);
  ...
  const handleCreateAssignment = async (data: {
    ...
    try {
      ...
      await assignmentService.createAssignment(room.id, {
        title: data.title,
  ...
  const handleSaveExamDates = async (examDates: any[]) => {
    try {
      ...
      await roomService.updateExamDates(room.id, formattedExamDates);
    ...
    <div className="max-w-5xl mx-auto p-8 space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          <Badge variant="primary" size="md">{room.subject}</Badge>
          {room.is_private && <Badge variant="warning" size="md">Private</Badge>}
        </div>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    await roomService.updateSyllabus(room.id, syllabusToSave);
