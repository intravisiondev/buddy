...
import { Users, Grid3x3, List, Search, Plus, Sparkles, MessageCircle, BookOpen, Lock, Loader } from 'lucide-react';
import { useApp } from '../contexts/AppContext';
import { useAuth } from '../contexts/AuthContext';
import { useApiRooms } from '../hooks/useApi';
...
export default function RoomList() {
  ...
  const { rooms, loading, loadRooms, createRoom, joinRoom } = useApiRooms(selectedSubject, isTeacher);
