...
import { useWailsDashboard, useWailsRooms } from '../hooks/useWails';
...
export default function StudentDashboard() {
  ...
  const { user } = useAuth();
  const { stats, goals, studyPlans, challenges, loading, toggleGoal, loadDashboardData } = useWailsDashboard();
  const { rooms, loadRooms } = useWailsRooms();
